...
import { idlFactory } from './identity_auth.did.js';
export { idlFactory } from './identity_auth.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_IDENTITY_AUTH;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./identity_auth.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the identity_auth canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./identity_auth.did.js")._SERVICE>}
 */
export const identity_auth = createActor(canisterId);
