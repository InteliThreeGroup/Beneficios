...
import { createActor } from '../../../declarations/llmo_home';
...
const FloatingChatbot = () => {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      text: "Hello! 👋 I'm the BeneChain virtual assistant. How can I help you understand our platform?",
      sender: 'bot',
      timestamp: new Date()
    }
  ]);
  ...
  // Reference to the canister actor
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const errorMessage = {
        id: Date.now() + 1,
        text: "Sorry, there was an error processing your question. Please try again in a few moments.",
        sender: 'bot',
        timestamp: new Date()
      };
        ...
        <div className="fixed bottom-6 right-6 z-50 bg-white rounded-lg shadow-2xl border border-gray-200 w-96 h-[500px] flex flex-col">
          ...
          <div className="bg-blue-600 text-white p-4 rounded-t-lg flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="font-semibold">BeneChain Assistant</h3>
          ...
          <div className="p-4 border-t border-gray-200">
            <div className="flex space-x-2">
              <input
                ...
                placeholder="Type your question about BeneChain..."
