...
export default function HRManualPayment() {
    ...
    const handlePayment = async (e) => {
        ...
        try {
            ...
            // Using creditBalance which is the correct function for manual payments
            ...
            if (result.ok) {
                setMessage({ text: `Payment of $${amount} to ${workerPrincipal.substring(0,10)}... completed!`, type: 'success' });
    ...
    return (
        <div className="bg-white rounded-xl shadow-md p-6">
            <h3 className="text-xl font-semibold text-gray-900 mb-4">Manual One-Time Payment</h3>
            <form onSubmit={handlePayment} className="space-y-4">
                <div>
                    <label htmlFor="mpWorkerPrincipal" className="block text-sm font-medium text-gray-700">Worker Principal</label>
                ...
                <div>
                    <label htmlFor="mpAmount" className="block text-sm font-medium text-gray-700">Amount (ICP)</label>
                    <div className="mt-1 relative">
                ...
                <div>
                    <label htmlFor="mpBenefitType" className="block text-sm font-medium text-gray-700">Benefit Type</label>
                ...
                <div>
                    <label htmlFor="mpDescription" className="block text-sm font-medium text-gray-700">Description</label>
                    <div className="mt-1 relative">
                        <FileText className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-400" />
                        <input type="text" id="mpDescription" value={description} onChange={(e) => setDescription(e.target.value)} required className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg" placeholder="Ex: Performance bonus"/>
                    </div>
                </div>
