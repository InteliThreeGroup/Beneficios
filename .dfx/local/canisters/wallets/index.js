...
import { idlFactory } from './wallets.did.js';
export { idlFactory } from './wallets.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_WALLETS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./wallets.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the wallets canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./wallets.did.js")._SERVICE>}
 */
export const wallets = createActor(canisterId);
