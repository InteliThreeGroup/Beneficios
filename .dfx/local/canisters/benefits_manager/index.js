...
import { idlFactory } from './benefits_manager.did.js';
export { idlFactory } from './benefits_manager.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_BENEFITS_MANAGER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./benefits_manager.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the benefits_manager canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./benefits_manager.did.js")._SERVICE>}
 */
export const benefits_manager = createActor(canisterId);
