...
import { idlFactory } from './establishment.did.js';
export { idlFactory } from './establishment.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ESTABLISHMENT;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./establishment.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the establishment canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./establishment.did.js")._SERVICE>}
 */
export const establishment = createActor(canisterId);
